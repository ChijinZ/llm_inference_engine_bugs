...
logging.basicConfig(level=logging.INFO,
                    ...
                    handlers=[
                        logging.FileHandler('data/root_cause_analysis.log'),
...
def main():
    ...
    # Run analysis
    input_file = 'data/final_bug_results.json'
    output_file = 'data/final_bug_results_with_root_cause.json'
    diff_output_file = 'data/bug_diffs.json'
