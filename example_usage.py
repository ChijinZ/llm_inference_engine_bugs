...
def example_basic_usage():
    ...
    # Save results
    collector.save_results(bugs, "example_bugs.json")
...
def example_custom_repositories():
    ...
    # Save results
    collector.save_results(bugs, "custom_repos_bugs.json")
...
def example_export_filtered_results(bugs, filename="filtered_bugs.json"):
